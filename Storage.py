...
class Main:
    ...
    def AddTableProductGUI(self):
        ...
        # Button
        self.ContinueB = customtkinter.CTkButton(self.application, text="Add Product", font=("calibri", 18), width=250, height=35, fg_color="#47A641", hover_color="#3E9338", corner_radius=2, command=lambda: self.AddTableProduct(amounts=self.ProductAmountE.get()))
